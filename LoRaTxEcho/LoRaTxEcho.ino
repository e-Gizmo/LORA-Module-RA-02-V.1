...
#define pingo 19          // pin for push-button
#define pinf  7          // pin for signaling led

#define MESS "HELLO WORLD"    // message to send and receive
...
int SF=11;  //Spreading factor value (if changed for test)
int BW=125;  //Bandwidth value (if changed for test)
